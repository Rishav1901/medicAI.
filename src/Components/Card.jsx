                    ...
                    <div className="flex flex-wrap -m-4 justify-center lg:gap-y-[5vw] lg:gap-x-[10vw]">
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://i.ibb.co/qgj7wxY/image.png" alt="diabetes" />
                                <div className="p-6">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Category</h2>
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Diabetes Prediction</h1>
                                    ...
                                    <div className="flex items-center flex-wrap ">
                                        <Link to="https://disease-app-gemini.streamlit.app/" target="_blank" className="text-[#3A8799] inline-flex items-center md:mb-2 lg:mb-0 hover:bg-opacity-[0.1] hover:text-black rounded-lg group hover:scale-110 duration-300 ">Diagnose Now
                        ...
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://i.ibb.co/bs4s6bF/image.png" alt="blog" />
                                <div className="p-6">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Category</h2>
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Heart Disease Prediction</h1>
                                    ...
                                    <div className="flex items-center flex-wrap ">
                                        <Link to="https://disease-app-gemini.streamlit.app/" className="text-[#3A8799] inline-flex items-center md:mb-2 lg:mb-0 hover:bg-opacity-[0.1] hover:text-black rounded-lg group hover:scale-110 duration-300 ">Diagnose Now
                                            <svg className="w-4 h-4 ml-2 group-hover:translate-x-3 duration-300 " viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" >
                                                <path d="M5 12h14"></path>
                                                <path d="M12 5l7 7-7 7"></path>
                                            </svg>
                        ...
                        <div className="p-4 md:w-1/2 lg:w-1/3">
                            <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                                <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://i.ibb.co/cLSsy7x/image.png" alt="diabetes" />
                                <div className="p-6">
                                    <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Category</h2>
                                    <h1 className="title-font text-lg font-medium text-gray-900 mb-3">Parkinsons Prediction</h1>
